                        ...
                        <div style={{ display: "grid", gap: 8 }}>
                            {sortedScores.map((row) => (
                                ...
                                >
                                    ...
                                    >
                                        <UserAvatar
                                            name={getPlayerName(match, row.playerId)}
                                            username={getPlayerById(match, row.playerId)?.username ?? row.playerId}
                                            imageUrl={getPlayerById(match, row.playerId)?.avatar_url ?? null}
                                            size={34}
                                            fontSize={11}
                                        />
                                        ...
                                        >
                                            {getPlayerName(match, row.playerId)}
                                        </span>
                                    </div>
