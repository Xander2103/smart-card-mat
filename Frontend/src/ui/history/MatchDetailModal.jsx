...
function PlayerMiniIdentity({ player, subtitle, avatarSize = 34 }) {
  return (
    <PlayerIdentity
      player={player}
      name={player?.name ?? "-"}
      ...
      avatarFontSize={avatarSize <= 30 ? 10 : 11}
      nameFontSize={avatarSize <= 30 ? 14 : 15}
      subtitle={subtitle}
      compact
    />
  );
                    ...
                    return (
                      ...
                      >
                        <PlayerMiniIdentity
                          player={player}
                          avatarSize={30}
                          subtitle={isChooser ? "chooser" : player.source}
                        />
          ...
          <div style={sectionStyle}>
            ...
            <div style={{ display: "grid", gap: 8 }}>
              {sortedScores.map((row) => {
                const player = getPlayerById(match, row.playerId);
                ...
                return (
                  ...
                  >
                    <PlayerMiniIdentity
                      player={player ?? { name: row.playerId, playerId: row.playerId }}
                      avatarSize={34}
                      subtitle={player?.source ?? ""}
                    />
