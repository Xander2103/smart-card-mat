...
<Section title="Algemene spelregels">
  ...
  <ul style={{ marginTop: 10, marginBottom: 0 }}>
    <li>
      De speler die uitkomt, speelt de eerste kaart van de slag. Die kaart bepaalt
      welke soort gevolgd moet worden.
    </li>
    <li>
      Als je een kaart hebt van dezelfde soort als de uitgekomen kaart
      (schoppen, harten, klaveren of ruiten), <b>ben je verplicht die soort te volgen</b>.
    </li>
    <li>
      Je mag dus geen andere soort spelen zolang je nog een kaart hebt van de
      gevraagde soort.
    </li>
    <li>
      Als je de gevraagde soort niet hebt, mag je een andere kaart spelen.
    </li>
    <li>
      De hoogste kaart van de gevraagde soort wint de slag, behalve wanneer er in
      een troefcontract troef gespeeld wordt.
    </li>
    <li>
      De winnaar van een slag komt uit in de volgende slag, tenzij een specifiek
      contract vroeger stopt.
    </li>
    <li>
      Bij contracten waarbij bepaalde kaarten minpunten geven, ben je verplicht
      die kaarten te spelen <b>wanneer dat volgens de volgregels mogelijk is</b>.
    </li>
  </ul>
</Section>
...
<Section title="Fase 1 – Contracten">
  ...
  <ul style={{ marginTop: 10, marginBottom: 0 }}>
    ...
    <li>
      De speler die het contract kiest, komt dus <b>niet zelf automatisch uit</b>.
      De volgende speler in de rij begint de eerste slag.
    </li>
    <li>
...
<Section title="Belangrijk bij minpuntencontracten">
  ...
  <ul style={{ marginTop: 10, marginBottom: 0 }}>
    <li>
      Als je de gevraagde soort hebt, <b>moet je volgen</b>.
    </li>
    <li>
      Als je binnen die soort een kaart hebt die minpunten kan veroorzaken,
      dan ben je verplicht die te spelen als dat volgens de regels moet.
    </li>
    <li>
      Je mag dus niet bewust een andere soort spelen om een minpuntkaart te
      ontwijken als je nog kunt volgen.
    </li>
    <li>
      De volgregel heeft altijd voorrang: eerst kijken of je dezelfde soort hebt,
      daarna pas mag je iets anders spelen.
    </li>
  </ul>
</Section>
...
<Section title="Troefregels">
  <ul style={{ marginTop: 0, marginBottom: 0 }}>
    ...
    <li>
      Als er één of meerdere troefkaarten gespeeld worden, wint de hoogste troef.
    </li>
    <li>
      Als er geen troef gespeeld wordt, wint de hoogste kaart van de gevraagde soort.
    </li>
    <li>De winnaar van de slag komt de volgende slag uit.</li>
    <li>
      De speler die troef kiest, kiest alleen de troefkleur; de <b>volgende speler
      in de rij</b> begint de eerste slag.
    </li>
  </ul>
</Section>
